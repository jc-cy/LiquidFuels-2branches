...
public final class LiquidFuelBlocks {
    ...
    public static final Supplier<FuelTankBlock> SMALL_FUEL_TANK = registerTank("small_fuel_tank", LiquidFuelConfig.DEFAULT_SMALL_FUEL_TANK_CAPACITY);
    public static final Supplier<FuelTankBlock> FUEL_TANK = registerTank("fuel_tank", LiquidFuelConfig.DEFAULT_FUEL_TANK_CAPACITY);
    public static final Supplier<FuelTankBlock> LARGE_FUEL_TANK = registerTank("large_fuel_tank", LiquidFuelConfig.DEFAULT_LARGE_FUEL_TANK_CAPACITY);
