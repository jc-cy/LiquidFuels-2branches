...
public final class LiquidFuelBlocks {
    ...
    public static final RegistryObject<FuelTankBlock> SMALL_FUEL_TANK = registerTank("small_fuel_tank", 1000);
    public static final RegistryObject<FuelTankBlock> FUEL_TANK = registerTank("fuel_tank", 5000);
    public static final RegistryObject<FuelTankBlock> LARGE_FUEL_TANK = registerTank("large_fuel_tank", 20000);
